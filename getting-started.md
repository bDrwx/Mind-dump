...
- [ ] You can use Foam for your daily notes, or journaling. Execute now the `Foam: Open [[2025-03-29]] Note` command to create a new file in your `journal` folder. See [[daily-notes]].
